...
import '../styles/TwitterHashtag.css';
    ...
    const handleSearch = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                'http://localhost:8000/api/scrape_hashtag/',
                { hashtag },
                {
                    headers: {
            ...
            await axios.post(
                'http://localhost:8000/api/twitter-hashtag-history/',
                {
        ...
        <div className="container">
            ...
            <form onSubmit={handleSearch}>
                <input 
                    ...
                    required
                />
                <button type="submit" className="twitterhashtag-button" disabled={loading}>
                    {loading ? 'Loading...' : 'Get Hashtags'}
                </button>
                <button type="button" className="twitterhashtag-reset-button" onClick={handleReset}>Reset</button>
                <button type="button" className="twitterhashtag-visualization-button" onClick={handleToggleVisualization}>
                    {showVisualization ? 'Back' : 'Get Visualization'}
                </button>
            </form>
            <div className="content-container">
                <div className={`hashtagresults-container ${showVisualization ? 'slide-left' : 'slide-right'}`}>
                    {loading && (
                ...
                <div className={`hashtag-pie-chart-container ${showVisualization ? 'slide-left' : 'slide-right'}`}>
                    <h2>Pie Chart</h2>
                    <Pie 
